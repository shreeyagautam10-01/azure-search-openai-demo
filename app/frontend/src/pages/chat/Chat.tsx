            ...
            <div className={styles.chatRoot}>
                <div className={styles.chatContainer}>
                    {!lastQuestionRef.current ? (
                        ...
                        <BotSparkleFilled fontSize={"60px"} primaryFill={"rgba(9, 9, 9, 0.8)"} aria-hidden="true" aria-label="Chat logo"/>
                        <h1 className={styles.chatEmptyStateTitle}>Caddie Healthcare</h1>
                            <h2 className={styles.chatEmptyStateSubtitle}>Hygiene: The Healthcare Bot is configured to answer Healthcare related questions</h2>
                        </div>
                    ) : (
                    ...
                    <div className={styles.chatInput}>
                        <QuestionInput
                            clearOnSend
                            placeholder="Type hi to start the conversation with Hygiene: The Healthcare Bot"
                            disabled={isLoading}
